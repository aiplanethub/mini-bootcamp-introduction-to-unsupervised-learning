...
* Can we get around this problem and still benefit from high dimensions?
...
* **Works well for Non-Linear data:** It can interpret the complex relationship between features and represent similar data points in high dimensions to close together in low dimensions.
